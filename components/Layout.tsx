  ...
  return (
    <div className={`min-h-screen flex flex-col ${isDark ? 'dark' : ''}`}>
      <div className="flex-1 bg-gray-50 dark:bg-gray-900 flex flex-col h-full">
        ...
        <header className="bg-pitch-600 dark:bg-pitch-800 text-white p-4 shadow-lg sticky top-0 z-20 safe-top">
        ...
        <main className="flex-1 w-full max-w-5xl mx-auto p-3 sm:p-4 pb-[calc(5rem+env(safe-area-inset-bottom))]">
          {children}
        </main>
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`flex flex-col items-center justify-center py-2 px-1 w-full transition-colors active:scale-95 touch-manipulation ${
                    isActive
                ...
                >
                  ...
                  <span className="text-[10px] sm:text-xs mt-1 truncate max-w-full">{tab.label}</span>
                </button>
              );
            })}
          </div>
